    ...
    <div className="relative w-full py-12 m-auto bg-transparent text-white md:max-w-[1780px] max-w-[600px]">
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="hidden md:flex">
          <a href="/resume.pdf" target="_blank" className="p-3 rounded-md font-bold" style={{ backgroundColor: colors.orange }}>Resume ↓</a>
        </div>
      ...
      <div className={toggle ? 'absolute m-auto z-10 bg-[#111111] w-full px-8' : 'hidden'}>
        <ul className="flex flex-col text-center">
          ...
          <div className="flex flex-col my-4 gap-4">
            <a href="/resume.pdf" target="_blank" className="px-8 py-3 text-center rounded-md bg-[#ee7600] font-bold">Resume ↓</a>
          </div>
        </ul>
      </div>
    </div>
